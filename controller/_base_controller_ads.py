...
from controller.ui_controller_ads import UIControllerADS
...
class MainController(QMainWindow):
    ...
    def _init_subcontrollers(self):
        ...
        self.ui_ctrl = UIControllerADS(self)  # Usar la versión ADS del UI Controller
    ...
    def _setup_ui(self):
        ...
        self.ui_ctrl.setup_dock_manager()
        ...
        # Intentar cargar layout guardado automáticamente
        self._load_auto_layout()
        
        self.logger.info("✅ UI configurada con PyQtAds")
        ...
        if os.path.exists(auto_layout):
            try:
                with open(auto_layout, 'rb') as f:
                    state = f.read()
                self.ui_ctrl.dock_manager.restoreState(state)
